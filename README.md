...
If you are using pycharm or python editor , use run feature to run entertainment_center.py If you are in windows , use IDLE to run entertainment_center.py
